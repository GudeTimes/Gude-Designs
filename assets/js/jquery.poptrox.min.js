  ...
  (e.fn.poptrox_disableSelection = function () {
    ...
    (e.fn.poptrox = function (o) {
      ...
      var p,
        ...
        u = [],
        index = 1,
        images = [4, 3, 5, 6, 4, 6, 6, 5, 4, 5]; // EDIT THIS LIST
      (d = 0),
        (h = !1),
        (g = new Array()),
        (f = function () {
      ...
      return (
        ...
        x
          ...
          .on("poptrox_next", function () {
            index++;
            index > images[d] && (index = 1), x.trigger("poptrox_switch", [d]);
            gtag("event", "Photo Interaction", {
              event_category: "poptrox_next",
              value: index,
            });
          })
          .on("poptrox_previous", function () {
            index--;
            index < 1 && (index = images[d]), x.trigger("poptrox_switch", [d]);
            gtag("event", "Photo Interaction", {
              event_category: "poptrox_previous",
              value: index,
            });
          })
          ...
          .on("poptrox_switch", function (o, t, p) {
            ...
            if (
              ...
              w.detach(),
              (i = u[t]),
              (i.src = `images/projectFulls/${t + 1}/${index}.${
                // File extension for fulls; use `gif` for specific project
                t == 4 ? "gif" : "jpg"
              }`),
              (w = i.object),
              w.off("load"),
